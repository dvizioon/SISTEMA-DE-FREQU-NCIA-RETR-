<?php
    ...
    $mysql = "SELECT * FROM  frequencia_dados ORDER BY id ASC";
        ...
        <div class="m-4" id="TD">
            <div class="div_header">
                <ul class="heade_nav_tb">
                    ...
                    <li><a id='li2' href="#" style="margin-left:45px;">nome</a></li>
                    <li><a id='li2' href="#" style="margin-left:210px;">Cpf</a></li>
                    <li><a id='li3' href="#" style="margin-left:140px;">Data_Hora</a></li>
                    <li><a id='li4' href="#" style="margin-left:45px;">Faltas</a></li>
                </ul>
            </div>
        ...
        <tbody>
           <?php
                while($user_data = mysqli_fetch_assoc($resut)){
                    echo "<tr>";
                    echo "<td style='font-size:14px;'>".$user_data['id']."</td>";
                    echo "<td style='font-size:14px;'>".$user_data['nome']."</td>";
                    echo "<td></td>";
                    echo "<td style='font-size:14px;'>".$user_data['Cpf']."</td>";
                    echo "<td style='font-size:14px;'>".$user_data['dataTm']."</td>";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td style='font-size:14px;'>".$user_data['frq_aluno']."</td>";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td></td>";
